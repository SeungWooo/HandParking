...
public class LocationTOS extends AppCompatActivity {
    private TextView servi2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setTitle("위치기반서비스 이용약관");
        setContentView(R.layout.activity_location_tos);
        servi2 = (TextView) findViewById(R.id.service2);
        loadDoc2();
    }
    private void loadDoc2() {
        String s2 = "제 1 조 (목적) 본 약관은 회원( 내손의 주자장 서비스를 이용하는 모든사람을 말합니다 서비스 약관에 동의한 자를 말합니다. 이하 \"회원\"이라고 합니다.)\n" +
                "이 내손의 주차장 (이하 \"회사\"라고 합니다.)이 제공하는 내손의 주차장 서비스(이하 \"서비스\"라고 합니다)를 이용함에\n" +
                ...
                "서비스 명\t서비스 내용\n" +
                "내손의 주차장 \t사용자 위치기반 주차장 정보안내, 실시간 위치확인이용자의 위치에서 적합한 주차장 정보 제공 \n" +
                "제 5 조 (서비스 이용요금) \n" +
                ...
                " \n" +
                "부 칙\n" +
                "제1조 (시행일) 이 약관은 2018년01월01일 부터 시행한다. \n" +
                "제2조 위치정보관리책임자는 2018년01월01일 을 기준으로 다음과 같이 지정합니다. \n" +
                "1. 소     속 : 내손의 주차장 \n" +
                "2. 연 락 처 : 01072991337 \n";

        servi2.setMovementMethod(new ScrollingMovementMethod());
